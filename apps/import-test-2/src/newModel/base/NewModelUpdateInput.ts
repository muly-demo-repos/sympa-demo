...
class NewModelUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProductUpdateManyWithoutNewModelsInput,
  })
  @ValidateNested()
  @Type(() => ProductUpdateManyWithoutNewModelsInput)
  @IsOptional()
  @Field(() => ProductUpdateManyWithoutNewModelsInput, {
    nullable: true,
  })
  products?: ProductUpdateManyWithoutNewModelsInput;
}

export { NewModelUpdateInput as NewModelUpdateInput };
