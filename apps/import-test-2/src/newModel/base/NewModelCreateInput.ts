...
class NewModelCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProductCreateNestedManyWithoutNewModelsInput,
  })
  @ValidateNested()
  @Type(() => ProductCreateNestedManyWithoutNewModelsInput)
  @IsOptional()
  @Field(() => ProductCreateNestedManyWithoutNewModelsInput, {
    nullable: true,
  })
  products?: ProductCreateNestedManyWithoutNewModelsInput;
}

export { NewModelCreateInput as NewModelCreateInput };
