...
using ServiceWithHelm.APIs;
using ServiceWithHelm.APIs.Common;
using ServiceWithHelm.APIs.Dtos;
using ServiceWithHelm.APIs.Errors;
using ServiceWithHelm.APIs.Extensions;
...
{
    protected readonly ServiceWithHelmDbContext _context;

    public CustomersServiceBase(ServiceWithHelmDbContext context)
    {
        _context = context;
    }
